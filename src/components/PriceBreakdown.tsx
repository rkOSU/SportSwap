import { calculateEstimatedTotal, calculatePlatformFee, calculateRentalSubtotal, formatCurrency } from "../utils/pricing";
    ...
    <div className="rounded-lg border border-slate-200 bg-white p-5 shadow-card">
      ...
      <div className="mt-5 border-t border-slate-200 pt-4">
        <div className="flex justify-between gap-4">
          ...
          <span className="text-lg font-black text-forest-700">{formatCurrency(estimatedTotal)}</span>
        </div>
