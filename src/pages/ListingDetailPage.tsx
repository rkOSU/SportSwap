...
import { findListingById, findOwnerByName } from "../data/listings";

export function ListingDetailPage() {
  const { id } = useParams();
  const listing = id ? findListingById(id) : undefined;
    ...
    return (
      <div className="page-shell flex min-h-[60vh] flex-col items-center justify-center py-16 text-center">
        ...
        <p className="mt-3 max-w-md text-sm leading-6 text-slate-600">
          This rental may have moved or the link may be outdated. Browse the current GearLoop MVP
          inventory instead.
        </p>
